    ...
    return (
        <Layout hideNavigation={true}>
            <div className="h-screen flex items-center">
             <div className="max-w-xs mx-auto -mt-24 grow">
               <h1 className="text-6xl text-gray-300 mb-3 text-center">Login</h1>
               <Card className="" noPadding={true}>
                <div className="rounded-md overflow-hidden">
                 <button onClick={loginWithGoogle} className="flex w-full gap-4 items-center justify-center p-4 border-b borde-b-gray-300 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:scale-110 transition-all">
